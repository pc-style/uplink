/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c17fd7a42cc43d1b5f34cfb9b9948c5d)
// Runtime types generated with workerd@1.20260504.1 2026-05-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		UPLINK_BUCKET: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLINK_DEFAULT_TTL_SECONDS" | "UPLINK_MAX_JSON_BYTES" | "UPLINK_API_KEY" | "UPLINK_SIGNING_SECRET">> {}
}
